                ...
                {!session ? (
                    ...
                    <div className="relative">
                        ...
                        <button 
                            ...
                            className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 border border-gray-200 hover:bg-gray-200 transition overflow-hidden"
                        >
                            {session.user?.image ? (
...
<div className="flex gap-7 items-center justify-center sm:hidden">
            ...
            <div className={`${open ? 'flex' : 'hidden'} absolute top-[60px] left-0 w-full min-h-screen bg-white shadow-md py-4 flex-col items-start gap-4 px-5 text-sm md:hidden z-40`}>
                <Link href="/" className="block py-2 w-full border-b border-gray-100">Home</Link>
                <Link href="/about" className="block py-2 w-full border-b border-gray-100">About</Link>
